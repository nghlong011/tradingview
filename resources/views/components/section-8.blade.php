...
<section class="min-h-[400px] sm:min-h-[480px] md:min-h-[560px] relative flex flex-col gap-4 sm:gap-6 md:gap-8 items-center justify-center px-4 sm:px-6 md:px-8">
    ...
    <div class="w-full max-w-[280px] sm:max-w-[300px] md:max-w-[320px] relative z-10">
        <button class="relative w-full flex px-4 items-center justify-center rounded-lg overflow-hidden transition-all duration-300 py-2 sm:py-3 md:py-4 text-[#F4F4F4] font-semibold text-[16px] sm:text-[18px] md:text-[20px] leading-[20px] sm:leading-[22px] md:leading-[24px] w-full group cursor-pointer hover:scale-105">
